    ...
    for r in results:
        rows.append(
            ...
            "| {runs} | {status} | {notes} |".format(
                ...
                correctness=(fmt_audio_quality(r.get("audio_quality")) if r.get("correctness_kind") == "audio" else fmt_correctness(r.get("correctness_kind"), r.get("wer_median"), r.get("der_median"), r.get("f1_median"))),
