...
conformance suite, and end-to-end validation against converted checkpoints is
the follow-up. See the [MOSS Delay guide](docs/moss.md).
...
| MOSS Delay (MOSS-TTS-v1.5 / MOSS-TTSD) | model-advertised multilingual text | model voice or zero-shot reference WAV | 24 kHz | yes | untested | untested | untested | untested |
